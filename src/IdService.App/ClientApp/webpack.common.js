    ...
    new copyPlugin({
      patterns: [{
        ...
        },
        {
          ...
          to: 'lib/jquery.validate.min.js'
        },
        {
          from: './node_modules/jquery-validation-unobtrusive/dist/jquery.validate.unobtrusive.min.js',
          to: 'lib/jquery.validate.unobtrusive.min.js'
        },
        {
          from: './node_modules/jquery-validation-unobtrusive-bootstrap/dist/unobtrusive-bootstrap.js',
          to: 'lib/unobtrusive-bootstrap.js'
        },
        {
          from: './node_modules/bootstrap/dist/js/bootstrap.bundle.min.js',
          to: 'lib/bootstrap.bundle.min.js'
        },
        {
          from: './node_modules/bootstrap/dist/js/bootstrap.bundle.min.js.map',
          to: 'lib/bootstrap.bundle.min.js.map'
        },
        {
          from: '**/*',
          context: './src/',
